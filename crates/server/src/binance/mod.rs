...
/// Host for the combined-stream WebSocket endpoint (USDⓂ-Futures). The path
/// component varies by stream family: kline + aggTrade need `/market/stream`,
/// diff-depth needs `/stream`. URL builders live in [`ws`].

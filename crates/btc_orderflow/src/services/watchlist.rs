...
/// Default watchlist shown the first time the user opens the app. Single
/// entry until the symbols universe grows past the hardcoded BTC stub.
pub const DEFAULT_WATCHLIST: &[&str] = &["BTCUSDT"];
